...
public class Rit {
	...
	@OneToMany(cascade = CascadeType.ALL, mappedBy = "rit", fetch = FetchType.LAZY) // ophalen van pakketen uit tabel bij aanroep (many=paketten/one=rit)
	...
	public List<String> getAdreslijst() {
		List<String> adreslijst = new ArrayList<>();
